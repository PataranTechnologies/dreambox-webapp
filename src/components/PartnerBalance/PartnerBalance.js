...
import styles from "./PartnerBalance.module.css";

const PartnerBalance = ({location}) => {
  ...
  return (
    <div className={styles.partnerBalanceContainer}>
      <nav className={styles.partnerBalanceNavigation}>
        <span
...
export default withRouter(PartnerBalance);
