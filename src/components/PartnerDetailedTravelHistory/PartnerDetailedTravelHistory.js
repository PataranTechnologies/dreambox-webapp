...
import styles from "./PartnerDetailedTravelHistory.module.css";

const PartnerDetailedTravelHistory = ({ location }) => {
    ...
    <div className={styles.travelHistoryContainer}>
      ...
      <div className={styles.detailedTravelHistoryContainer}>
        ...
        <div className={styles.actionSection}>
          ...
          <button className={styles.modifyCost}>Modificar Costo</button>
        </div>
      </div>
    </div>
  );
...
export default withRouter(PartnerDetailedTravelHistory);
